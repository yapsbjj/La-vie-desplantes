...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'backup_LaVieDesPlantes_5c10642aaa6701e65791_20240110155219_archive.zip';
        const ARCHIVE_SIZE       = '53811108';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '5c10642-10155219';
        const SECONDARY_PACKAGE_HASH = '34bdfe5-10155219';
